...
public class QCM extends Question {
    ...
    public QCM(){}
    public QCM(DisplayQuestion dispqo,String title){
        super(dispqo,title);
    ...
    @Override
    public void afficherQuestionbridge(String title,ArrayList<Proposition> PropositionQCM) {
        displayQuestion.afficher(title,PropositionQCM);
